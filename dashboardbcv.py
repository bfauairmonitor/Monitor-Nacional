...
with col_sup_2: 
    try:
        ...
        fig2 = go.Figure(go.Bar(
            ...
            textfont=dict(size=24, color=C_BLANCO), width=0.7
        ))
        fig2.update_layout(
...
with col_inf_1: 
    try:
        ...
        fig5 = go.Figure()
        fig5.add_trace(go.Bar(x=fechas5, y=montos5, text=[f"{int(v):,}MM" for v in montos5], textposition='outside', marker_color=C_BARRA_INF, textfont=dict(color=C_BLANCO, size=24), width=0.4))
...
with col_inf_2: 
    try:
        ...
        fig4 = go.Figure()
        fig4.add_trace(go.Bar(x=fechas4, y=montos4, text=[f"{v:,.1f}MM" for v in montos4], textposition='outside', marker_color=C_BARRA_BASE, textfont=dict(color=C_BLANCO, size=24), width=0.4))
...
with col_inf_3: 
    try:
        ...
        fig6 = go.Figure()
        fig6.add_trace(go.Bar(x=fechas6, y=montos6, text=[f"{int(v):,}MM" for v in montos6], textposition='outside', marker_color=C_BARRA_RES, textfont=dict(color=C_BLANCO, size=24), width=0.5))
